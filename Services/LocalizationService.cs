    ...
    private static Dictionary<string, string> GetFallbackDictionary(string langCode)
    {
        return langCode switch
        {
            "en" => new Dictionary<string, string>
            {
                ...
                ["Tools_Bluetooth_Transfer"] = "Bluetooth Transfer (Send / Receive)",
                ...
                ["BT_Send"] = "Send Scores or Setlists",
                ["BT_Receive"] = "Receive Scores or Setlists",
                ...
                ["BT_Confirm_Receive_Msg"] = "Accept files sent by {0}?",
                ["About_Title"] = "About",
            ...
            _ => new Dictionary<string, string>
            {
                ...
                ["Tools_Bluetooth_Transfer"] = "Transfert Bluetooth (Envoi / Réception)",
                ...
                ["BT_Title"] = "Transfert Bluetooth",
                ["BT_Send"] = "Envoyer des partitions ou setlists",
                ["BT_Receive"] = "Recevoir des partitions ou setlists",
                ...
                ["BT_Confirm_Receive_Msg"] = "Accepter les éléments envoyés par {0} ?",
