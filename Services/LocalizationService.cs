    ...
    private static Dictionary<string, string> GetFallbackDictionary(string langCode)
    {
        return langCode switch
        {
            "en" => new Dictionary<string, string>
            {
                ...
                ["Setlists_Send"] = "Send Setlist",
                ["Setlists_Export"] = "Export Setlist",
                ["Tools_Wifi_Transfer"] = "Wi-Fi Direct Transfer (P2P)",
                ...
                ["Settings_Annotations"] = "Annotation Settings",
                ...
                ["Settings_ExportsPath"] = "Export files directory (Setlists, Scores)",
                ...
                ["Wifi_Title"] = "Wi-Fi Direct Transfer (P2P)",
                ["Wifi_Send"] = "Send Scores or Setlists",
                ["Wifi_Receive"] = "Receive Scores or Setlists",
                ["Wifi_Scanning"] = "Scanning for nearby devices...",
                ["Wifi_Scan_Devices"] = "Scan for Devices",
                ["Wifi_Stop_Scan"] = "Stop Scan",
                ["Wifi_Select_Device"] = "Select Target Device",
                ["Wifi_Transfer_Progress"] = "Transfer in progress...",
                ["Wifi_Transfer_Success"] = "Wi-Fi Direct transfer completed successfully!",
                ["Wifi_Transfer_Failed"] = "Wi-Fi Direct transfer failed.",
                ["Wifi_Confirm_Receive_Title"] = "Incoming Wi-Fi Direct Transfer",
                ["Wifi_Confirm_Receive_Msg"] = "Accept files sent by {0}?",
                ["About_Title"] = "About",
            ...
            "de" => new Dictionary<string, string>
            {
                ...
                ["Tools_Wifi_Transfer"] = "Wi-Fi Direct Übertragung (P2P)",
                ...
                ["Settings_Annotations"] = "Anmerkungs-Einstellungen",
                ...
                ["Wifi_Title"] = "Wi-Fi Direct Übertragung (P2P)",
                ["Wifi_Send"] = "Noten oder Setlists senden",
                ["Wifi_Receive"] = "Noten oder Setlists empfangen",
                ["Wifi_Scanning"] = "Suche nach Geräten in der Nähe...",
                ["Wifi_Scan_Devices"] = "Geräte suchen",
                ["Wifi_Stop_Scan"] = "Suche beenden",
                ["Wifi_Select_Device"] = "Zielgerät auswählen",
                ["Wifi_Transfer_Progress"] = "Übertragung läuft...",
                ["Wifi_Transfer_Success"] = "Wi-Fi Direct Übertragung erfolgreich abgeschlossen!",
                ["Wifi_Transfer_Failed"] = "Wi-Fi Direct Übertragung fehlgeschlagen.",
                ["Wifi_Confirm_Receive_Title"] = "Eingehende Wi-Fi Direct Übertragung",
                ["Wifi_Confirm_Receive_Msg"] = "Von {0} gesendete Dateien annehmen?",
                ["About_Title"] = "Über",
            ...
            "es" => new Dictionary<string, string>
            {
                ...
                ["Tools_Wifi_Transfer"] = "Transferencia Wi-Fi Direct (P2P)",
                ...
                ["Settings_Annotations"] = "Ajustes de Anotaciones",
                ...
                ["Settings_ExportsPath"] = "Directorio de archivos de exportación (Setlists, Partituras)",
                ...
                ["Wifi_Title"] = "Transferencia Wi-Fi Direct (P2P)",
                ["Wifi_Send"] = "Enviar partituras o setlists",
                ["Wifi_Receive"] = "Recibir partituras o setlists",
                ["Wifi_Scanning"] = "Buscando dispositivos cercanos...",
                ["Wifi_Scan_Devices"] = "Buscar dispositivos",
                ["Wifi_Stop_Scan"] = "Detener búsqueda",
                ["Wifi_Select_Device"] = "Seleccionar dispositivo destino",
                ["Wifi_Transfer_Progress"] = "Transferencia en curso...",
                ["Wifi_Transfer_Success"] = "¡Transferencia Wi-Fi Direct completada con éxito!",
                ["Wifi_Transfer_Failed"] = "La transferencia Wi-Fi Direct ha fallado.",
                ["Wifi_Confirm_Receive_Title"] = "Transferencia Wi-Fi Direct entrante",
                ["Wifi_Confirm_Receive_Msg"] = "¿Aceptar los archivos enviados por {0}?",
            ...
            _ => new Dictionary<string, string>
            {
                ...
                ["Setlists_Send"] = "Envoyer la Setlist",
                ["Setlists_Export"] = "Exporter la Setlist",
                ["Tools_Wifi_Transfer"] = "Transfert Wi-Fi Direct (P2P)",
                ...
                ["Settings_Annotations"] = "Paramètres Annotations",
                ...
                ["Settings_ExportsPath"] = "Répertoire des fichiers d'export (Setlists, Partitions)",
                ...
                ["Wifi_Title"] = "Transfert Wi-Fi Direct (P2P)",
                ["Wifi_Send"] = "Envoyer des partitions ou setlists",
                ["Wifi_Receive"] = "Recevoir des partitions ou setlists",
                ["Wifi_Scanning"] = "Recherche d'appareils en cours...",
                ["Wifi_Scan_Devices"] = "Rechercher des appareils",
                ["Wifi_Stop_Scan"] = "Arrêter la recherche",
                ["Wifi_Select_Device"] = "Sélectionnez un appareil cible",
                ["Wifi_Transfer_Progress"] = "Transfert en cours...",
                ["Wifi_Transfer_Success"] = "Transfert réussi avec succès !",
                ["Wifi_Transfer_Failed"] = "Échec du transfert Wi-Fi Direct.",
                ["Wifi_Confirm_Receive_Title"] = "Transfert entrant Wi-Fi Direct",
                ["Wifi_Confirm_Receive_Msg"] = "Accepter les éléments envoyés par {0} ?",
